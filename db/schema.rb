...
ActiveRecord::Schema.define(version: 20180415124300) do
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.string   "email"
    t.string   "group"
    t.boolean  "able_for_contact",         default: false
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "error_lives", force: :cascade do |t|
  ...
  create_table "preamble_elements", force: :cascade do |t|
    t.string   "name"
    t.text     "body"
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
  ...
  create_table "tests_info_pages", force: :cascade do |t|
    t.string   "title"
    t.text     "msg"
    t.string   "translit"
    t.datetime "created_at", null: false
  ...
  create_table "user_personal_consults", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "type_of_connection"
    t.string   "connection_address"
    t.index ["user_site_id"], name: "index_user_personal_consults_on_user_site_id"
  end
  ...
  create_table "user_sites", force: :cascade do |t|
    ...
    t.boolean  "active",     default: true
    t.string   "akey_short"
    t.decimal  "common_sum", default: "0.0"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
